...
\begin{cventries}
  ...
  \begin{cvskills}
    ...
    \cvskill{}{\entrylocationstyle{{\href{https://github.com/mukeshmk/fm-learn}{\faGithubSquare\ \textbf{FMLearn}}}}, an application which allows the exchange of meta-data about machine learning models and data for the purpose of meta-learned algorithm selection and configuration.}
  \end{cvskills}
